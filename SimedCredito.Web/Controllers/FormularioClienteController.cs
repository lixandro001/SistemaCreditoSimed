    ...
    public class FormularioClienteController : Controller
    {
        ...
        public IActionResult BandejaComercial()
        {
            if (HttpContext.Session.GetInt32("TOKEN") == null || HttpContext.Session.GetString("TOKEN")==null)
            {
                ...
                return RedirectToAction("Exit", "FormularioCliente");
            }
            return View();
        }
            ...
            IFormFile FormFile11, IFormFile FormFile12, IFormFile FormFile13)
        {
            ...
            else
            {
                try
                {
                    var code = Request.Form["CodeCliente"];
        ...
        public IActionResult EnviarFormularioCliente(IFormFile FormFile1, IFormFile FormFile2, IFormFile FormFile3, IFormFile FormFile4, IFormFile FormFile5,
        IFormFile FormFile6, IFormFile FormFile7, IFormFile FormFile8, IFormFile FormFile9, IFormFile FormFile10,
        IFormFile FormFile11, IFormFile FormFile12, IFormFile FormFile13)
        {
            var Response = new GenericObjectResponse();
